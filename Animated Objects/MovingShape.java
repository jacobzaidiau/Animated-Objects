...
public abstract class MovingShape {
    ...
    /*
     *  ===============================================================================
     *  CircularPath : A circular path.
     *  ===============================================================================
     */
    public class CircularPath extends MovingPath {
        private double stx =0, sinDeltay = 0, sinDeltax = 0;
        private int changeY = 1, changeX = 1;
       ...
       */
       public void move() {
    	   ...
    	   if (changeY == 1)
    		   topLeft.y = (int) Math.round(topLeft.y + (sinDeltay += stx));
    	   if (changeY == 2)
    		   topLeft.y = (int) Math.round(topLeft.y + (sinDeltay -= stx));
    	   if (sinDeltay < -10.5 && changeY == 2)
    		   changeY = 1;
    	   if (sinDeltay > 10 && changeY == 1)
    		   changeY = 2;
    	   
    	   //Handling the x-coordinates
    	   
    	   if (changeX == 1)
    		   topLeft.x = (int) Math.round(topLeft.x + (sinDeltax += stx));
    	   if (changeX == 2)
    		   topLeft.x = (int) Math.round(topLeft.x + (sinDeltax -= stx));
    	   if (sinDeltax < -10.5 && changeX == 2)
    		   changeX = 1;
    	   if (sinDeltax > 10 && changeX == 1)
    		   changeX = 2;
       }
    }
}
