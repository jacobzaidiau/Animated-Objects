...
public class AnimationPanel extends JComponent implements Runnable {
    ...
    protected void createNewShape(int x, int y) {
		...
		switch (currentShapeType) {
			case 0: { //rectangle
				shapes.add( new MovingRectangle(x, y, currentWidth,	currentHeight, marginWidth, marginHeight, currentFillColor, currentBorderColor, currentPathType));
				break;
			}
			case 1: { //oval
				shapes.add( new MovingOval(x, y, currentWidth,	currentHeight, marginWidth, marginHeight, currentFillColor, currentBorderColor, currentPathType));
				break;
			}
			case 2: { //checker
				shapes.add( new MovingChecker(x, y, currentWidth,	currentHeight, marginWidth, marginHeight, currentFillColor, currentBorderColor, currentPathType));
				break;
			}
			case 3: { //gradient
				shapes.add( new MovingGradient(x, y, currentWidth,	currentHeight, marginWidth, marginHeight, currentFillColor, currentBorderColor, currentPathType));
				break;
			}
			case 4: { //pattern
				shapes.add( new MovingPattern(x, y, currentWidth,	currentHeight, marginWidth, marginHeight, currentFillColor, currentBorderColor, currentPathType));
				break;
			}
		}
	}
